...
public class MainCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args) {
        ChangeSettings changeSettings = new ChangeSettings(plugin);
        ...
        if (args[0].equalsIgnoreCase("toggle")) {
            ...
            if (args.length == 3) {
                ...
                changeSettings.toggleSetting(settingToChange, playerToUse, true);
                return true;
            }

            Player player = (Player) sender;
            changeSettings.toggleSetting(settingToChange, player, false);
            return true;
        }
        if(args[0].equalsIgnoreCase("enable")){
            ...
            if(args.length == 1){
                messageSender.send(sender, "&cYou need to specify a setting to turn on");
                return true;
            }
            ...
            if(args.length == 3){
                ...
                changeSettings.enableSetting(settingToChange, playerToUse, true);
                return true;
            }

            Player player = (Player) sender;
            changeSettings.enableSetting(settingToChange, player, false);
            return true;
        }
        ...
        if(args[0].equalsIgnoreCase("disable")){
            ...
            if(args.length == 1){
                messageSender.send(sender, "&cYou need to specify a setting to turn off");
                return true;
            }
